...
caption.reversed <-
  "Items marked with a dagger (\u2020) are reverse coded so that all items in this question scale in the same direction.  Their response values were inverted (1=5, 2=4, 4=2, 5=1) before computing scale means and medians."
