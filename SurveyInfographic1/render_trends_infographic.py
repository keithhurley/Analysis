...
# Files to render
print_html = r"d:\Survey\Analysis\SurveyInfographic1\infographic_trends_print.html"
print_png = r"d:\Survey\Analysis\SurveyInfographic1\infographic_trends_print.png"

mobile_html = r"d:\Survey\Analysis\SurveyInfographic1\infographic_trends_mobile.html"
mobile_png = r"d:\Survey\Analysis\SurveyInfographic1\infographic_trends_mobile.png"
...
if __name__ == "__main__":
    ...
    # Delete existing files if any just in case
    for path in [print_png, mobile_png]:
    ...
    render_html_to_png(mobile_html, mobile_png, 1080, 2620)
